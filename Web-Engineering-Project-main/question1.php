...
<?php
    ...
    $number=(int) $_GET['n'];
     ...
     $query = "SELECT quizID FROM quizzes WHERE quizId=2 ";
     // Execute the query
    ...
    $query= "SELECT * FROM quiz ";
       ...
       $total=$results->num_rows;
        ...
        /*get question*/
    $query = "SELECT * FROM quiz WHERE  quesID = $number AND quizID=2";
        /*get result*/
    ...
    $question = $result->fetch_assoc();
        ...
        /*get choices*/
    $query = "SELECT * FROM choices WHERE quesID =$number AND quizID=2";
        /*get result*/
...
<body>
   ...
   <!--<?php echo $question['quesID'];?> of <?php echo $total;?>  -->
    ...
    <?php
         $query = "SELECT quizname FROM quizzes where quizID=2";
        // Execute the query
        $result = $con->query($query);
