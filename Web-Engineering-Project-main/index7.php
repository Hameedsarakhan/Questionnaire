...
<?php
   /* get total question of quiz 6*/
   $query="SELECT * FROM quiz where quizID=8";
...
<div class="quizimg"><img  src="quiz.jpeg"></div>
    ...
    <main>
        ...
        <?php
         $query = "SELECT quizname FROM quizzes where quizID=8";
        // Execute the query
...
?> 
       <div class="question">
         <!-- <p>This is multiple choice question to test your knowledge of Adobe Illustrator.</p> -->
        <ul class="list">
        ...
        <div class="buttons">
            <a href="question7.php?n=71" class="start">Start Quiz</a>
