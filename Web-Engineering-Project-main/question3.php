...
<?php
    ...
    $number=(int) $_GET['n'];
     ...
     $query = "SELECT quizID FROM quizzes WHERE quizId=4";
     // Execute the query
    ...
    $query= "SELECT * FROM quiz ";
       ...
       $total=$results->num_rows;
        ...
        /*get question*/
    $query = "SELECT * FROM quiz WHERE  quesID = $number AND quizID=4";
        /*get result*/
    ...
    $question = $result->fetch_assoc();
        ...
        /*get choices*/
    $query = "SELECT * FROM choices WHERE quesID =$number AND quizID=4";
        /*get result*/
