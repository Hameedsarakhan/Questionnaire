...
<?php
   /* get total question of quiz 9*/
   $query="SELECT * FROM quiz where quizID= 9";
...
<div class="quizimg"><img  src="quiz.jpeg"></div>
    ...
    <main>
        ...
        <?php
         $query = "SELECT quizname FROM quizzes where quizID= 9";
        // Execute the query
...
?> 
        ...
        <div class="buttons">
            <a href="question8.php?n=81" class="start">Start Quiz</a>
